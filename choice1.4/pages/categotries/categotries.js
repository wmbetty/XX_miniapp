...
Page({
  ...
  onLoad: function (options) {
    ...
    tid = topicId;
    let topicDetailsApi = backApi.cateDetailsApi+topicId;
    ...
    backApi.getToken().then(function(response) {
      if (response.data.status * 1 === 200) {
        ...
        let topicQuesApi = backApi.cateQuesApi+token;
  ...
  onReachBottom: function () {
    ...
    if (type*1===1) {
      if (page1>totalPage1) {
        ...
        Api.wxRequest(topicQuesApi,'GET',{category_id:topicId,type:1,page:page1},(res)=>{
          if (res.data.status*1===200) {
      ...
      if (page2>totalPage2) {
        ...
        Api.wxRequest(topicQuesApi,'GET',{category_id:topicId,type:2,page:page2},(res)=>{
          if (res.data.status*1===200) {
